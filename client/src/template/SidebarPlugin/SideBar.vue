...
<template>
  ...
  <div class="sidenav navbar navbar-vertical fixed-left navbar-expand-xs side-bar--custom" :data="backgroundColor">
    <div class="scrollbar-inner h-100" ref="sidebarScrollArea">
      <div class="sidenav-header d-flex align-items-center">
        <b-navbar-brand class="d-flex align-items-center justify-content-center w-100">
          <img src="../../../../client/src/assets/Logo/ComodeIcon.svg" class="side-bar-logo" />
        </b-navbar-brand>
      </div>
      <slot></slot>
