<template>
  <div class="card">
    <div class="card-image">
      <img src="https://i.ytimg.com/vi/5siNvZgGb7o/hq720.jpg?sqp=-oaymwEcCNAFEJQDSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&rs=AOn4CLBolyqAJltGtNb-2o-SOBAVlDAPIA" alt="">
    </div>
    <div class="card-body">
      <div class="card-title">
      Anh khoa có cùng đồng bọn đi thanh toán băng đảng xã hội đen 
    </div>
    <div class="card-auth text-gray">
      Rambo
    </div>
    <div class="card-info text-gray">
      <div class="card-info--view">72N views
      ...
      <div class="card-info--time">10 ngày trước</div>
    </div> 
    </div>
  </div>
</template>
