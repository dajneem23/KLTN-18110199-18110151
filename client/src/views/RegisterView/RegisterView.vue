<template>
  <div>
      ...
      <form class="form-login bgc-white">
        ...
        <div class="form-button">
          ...
          <!-- <button class="btn-google">
            ...
            <span> {{ REGISTER_ITEM.googleButton.title[lang] }} </span>
          </button> -->
        </div>
        <div class="form-more">
          <div></div>
    ...
    <div class="toastify-wrapper">
      <Toastify isSuccess content="Đăng ký thành công" v-if="isSuccess" />
      <Toastify isWarnning content="Đăng đăng ký thất bại" v-if="isWarnning" />
    </div>
  </div>
</template>
