<template>
  <div class="storyDetail-wrapper bgc-black" v-if="isShowDetail">
    <button class="btn btn-close" @click="hiddenModel">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" class="fill-white">
    ...
    <div class="boxDetail-right bgc-white">
      ...
      <div class="news-footer-top">
        ...
        <div class="news-cmt">
          ...
          <span class="text-dark--gray">{{comments?.length}} {{ HOME_ITEM.comment.title[lang] }}</span>
        </div>
      </div>
      <div class="news-footer-body">
        <button class="btn-dev btn-transparent like-news"  :class="{
          ...
          <span> {{ HOME_ITEM.likeBtn.title[lang] }} </span>
        </button>
        <button class="btn-dev btn-transparent like-news" 
          v-if="!isAuthenticated">
          <!-- /*Truyền vào id post*/ -->
    ...
    <div class="notifi-login-cmt" v-if="!isAuthenticated">Hãy đăng nhập để xem được bình luận</div>
...
<style lang="scss" src="./storyDetailView.scss" scoped>
</style>